 ...
 * 这是一个工具类，它向HP打印度量服务器发送度量信息。
 *它在HP打印SDK中使用，你不应该自己创建它。
 */
public class PrintMetricsCollector extends Thread {
     ...
     *                           / * *
     *在打印SDK中调用发送与打印相关的数据到HP服务器。
     * @param活动
     * @param  printJob 打印作业所产生的 printmanager
     * @param中的键/值哈希格式的任何指标的相关数据appspecificmetrics。
     * /
     */
     ...
     * @param活动
     * @param printJob 打印作业所产生的printmanager
     */
    ...
    public void run() {
        ...
        if (hasJobInfo(printJob) || printJobInfoString.contains("PDF printer")) {
            ...
            printMetricsData.printResult = PrintMetricsData.PRINT_RESULT_SUCCESS;//打印机接受到数据，返回success
...
//            a=returnPrintResult(printJob);
    ...
    发起网络请求
     */
    public void postMetricsToHPServer(final Context context, final PrintMetricsData data) {
        ...
        StringRequest sr = new StringRequest(Request.Method.POST, MetricsUtil.getMetricsServer(context) + API_METHOD_NAME, new Response.Listener<String>() {
            ...
            protected Map<String,String> getParams(){
                ...
                Log.i("Test",params.size()+"");
//                Toast.makeText(context, "返回结果："+params.get("print_result"), Toast.LENGTH_SHORT).show();
                return params;
            }
