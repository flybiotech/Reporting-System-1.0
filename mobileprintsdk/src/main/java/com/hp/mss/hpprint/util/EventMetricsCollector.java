...
public class EventMetricsCollector {
    ...
    private EventMetricsCollector(Context context){
    ...
    public static void postMetricsToHPServer(final Activity activity, PrintFlowEventTypes eventType) {
