...
import com.shizhenbao.interfaceCall.DirectoryChooserInteraction;
...
//        else if(view.getId() == R.id.btn_download){//另存为
//            if (0 == checkIndex){
//                mAdapter.getSDImageFragment().download();
//
//            }
//            else if(1 == checkIndex){
//                mAdapter.getSDVideoFragment().download();
//            }
//        }
...
//        Log.e(tag,"---choose path is "+path);
//        if (0 == checkIndex){
//            mAdapter.getSDImageFragment().chooseOrCancel(0,path);
//        }
//        else if(1 == checkIndex){
//            mAdapter.getSDVideoFragment().chooseOrCancel(0,path);
//        }
//    }
...
//
//        if (0 == checkIndex){
//            mAdapter.getSDImageFragment().chooseOrCancel(1,"");
//        }
//        else if(1 == checkIndex){
//            mAdapter.getSDVideoFragment().chooseOrCancel(1,"");
//        }
//    }
}
