...
public class ImageManagerYET extends BaseAdapter{
    ...
    public ImageManagerYET(Context context, List<Item> list) {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        viewHolder.iv.setOnClickListener(new View.OnClickListener() {//点击图片进行预览
            ...
            public void onClick(View v) {
                //6.0尺寸以下的设备，跳到这个界面
//                OneItem.getOneItem().setJianjiPath(list.get(i).getPath());//将选择的图片路径保存在实体类中
