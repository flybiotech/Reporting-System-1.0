...
//        mLoadMoreStatus=status;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View view){
            super(view);
            imageView=(ImageViewRotation)view.findViewById(R.id.image);
...
//        Logger.e(" 文件名称v：filePath "+filePath);
        ...
        try {
            ...
            if (split.length > 0) {
                imageCatagory = changeInfo(split[1]);
                if (split[1].equals("cusuanbai")) {
                    imageCatagory = imageCatagory + ":" + split[2] + MyApplication.getContext().getString(R.string.imageacitivty_acetowhite_second) +
